...
Date: 1/27/20
Project: Google API search for PubMed Central
Documentation on API used: https://developers.google.com/custom-search/v1/overview
Custom search ID – 003950716982973815356:qbeatnpdnur
Public URL - https://cse.google.com/cse?cx=003950716982973815356:qbeatnpdnur
...
def retrieve(q):
    ...
    cse_id = '003950716982973815356:qbeatnpdnur'
    if query == '':
