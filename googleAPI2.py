...
Date: 1/1/20
Project: Google API search Government & Academic domains
Documentation on API used: https://developers.google.com/custom-search/v1/overview
Custom search ID – 003950716982973815356:qblywevunca
Public URL - https://cse.google.com/cse?cx=003950716982973815356:qblywevunca
...
def retrieve(q):
    ...
    cse_id = '003950716982973815356:qblywevunca'
    if query == '':
