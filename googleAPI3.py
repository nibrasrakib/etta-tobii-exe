...
Date: 1/1/20
Project: Google API search life science domains
Documentation on API used: https://developers.google.com/custom-search/v1/overview
Custom search ID – 003950716982973815356:1zpc9syjapj
Public URL - https://cse.google.com/cse?cx=003950716982973815356:1zpc9syjapj
...
def retrieve(q):
    ...
    cse_id = '003950716982973815356:1zpc9syjapj'
    if query == '':
