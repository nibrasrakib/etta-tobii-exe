...
Date: 11/16/19
Project: Google API search computing and information science domains
Documentation on API used: https://developers.google.com/custom-search/v1/overview
Custom search ID – https://cse.google.com/cse/setup/basic?cx=003950716982973815356:grutrzqnvov
...
def retrieve(q):
	...
	cse_id = '003950716982973815356:grutrzqnvov'
	if query == '':
